...
const AuthCallbackPage = nextDynamic<RouteComponentProps>(
  () =>
    import("@/views/AuthCallback").then(
...
export default function ClientPage() {
  return <AuthProvider><ThemeProvider><AuthCallbackPage /></ThemeProvider></AuthProvider>;
}
