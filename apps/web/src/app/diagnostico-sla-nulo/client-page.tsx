...
const DiagnosticoSlaNuloPage = nextDynamic<RouteComponentProps>(
  () =>
    import("@/views/DiagnosticoSLANulo").then(
...
export default function ClientPage() {
  return <AuthProvider><ThemeProvider><DiagnosticoSlaNuloPage /></ThemeProvider></AuthProvider>;
}
