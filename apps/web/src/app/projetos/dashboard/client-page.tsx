...
const DashboardProjetosPage = nextDynamic<RouteComponentProps>(
  () =>
    import("@/views/DashboardProjetos").then(
...
export default function ClientPage() {
  return <AuthProvider><ThemeProvider><DashboardProjetosPage /></ThemeProvider></AuthProvider>;
}
