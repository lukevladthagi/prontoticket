...
const ConfigurarTelegramPage = nextDynamic<RouteComponentProps>(
  () =>
    import("@/views/ConfigurarTelegram").then(
...
export default function ClientPage() {
  return <AuthProvider><ThemeProvider><ConfigurarTelegramPage /></ThemeProvider></AuthProvider>;
}
