...
const ContratosPage = nextDynamic<RouteComponentProps>(
  () =>
    import("@/views/Contratos").then(
...
export default function ClientPage() {
  return <AuthProvider><ThemeProvider><ContratosPage /></ThemeProvider></AuthProvider>;
}
