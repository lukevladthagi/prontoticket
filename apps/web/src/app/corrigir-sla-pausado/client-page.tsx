...
const CorrigirSLAPausadoPage = nextDynamic<RouteComponentProps>(
  () =>
    import("@/views/CorrigirSLAPausado").then(
...
export default function ClientPage() {
  return <AuthProvider><ThemeProvider><CorrigirSLAPausadoPage /></ThemeProvider></AuthProvider>;
}
