...
const RelatorioTicketsPage = nextDynamic<RouteComponentProps>(
  () =>
    import("@/views/RelatorioTickets").then(
...
export default function ClientPage() {
  return <AuthProvider><ThemeProvider><RelatorioTicketsPage /></ThemeProvider></AuthProvider>;
}
