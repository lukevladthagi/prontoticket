...
const AnaliseSLAPage = nextDynamic<RouteComponentProps>(
  () =>
    import("@/views/AnaliseSLA").then(
...
export default function ClientPage() {
  return <AuthProvider><ThemeProvider><AnaliseSLAPage /></ThemeProvider></AuthProvider>;
}
