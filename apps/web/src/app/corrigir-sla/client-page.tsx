...
const CorrigirSLAPage = nextDynamic<RouteComponentProps>(
  () =>
    import("@/views/CorrigirSLA").then(
...
export default function ClientPage() {
  return <AuthProvider><ThemeProvider><CorrigirSLAPage /></ThemeProvider></AuthProvider>;
}
