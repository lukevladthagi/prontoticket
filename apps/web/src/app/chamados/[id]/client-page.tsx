...
const ChamadoDetalhePage = nextDynamic<RouteComponentProps>(
  () =>
    import("@/views/ChamadoDetalhe").then(
...
export default function ClientPage() {
  return <AuthProvider><ThemeProvider><ChamadoDetalhePage /></ThemeProvider></AuthProvider>;
}
