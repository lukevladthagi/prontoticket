...
const RelatorioSetoresPage = nextDynamic<RouteComponentProps>(
  () =>
    import("@/views/RelatorioSetores").then(
...
export default function ClientPage() {
  return <AuthProvider><ThemeProvider><RelatorioSetoresPage /></ThemeProvider></AuthProvider>;
}
