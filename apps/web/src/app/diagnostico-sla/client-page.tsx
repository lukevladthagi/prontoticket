...
const DiagnosticoSLAPage = nextDynamic<RouteComponentProps>(
  () =>
    import("@/views/DiagnosticoSLA").then(
...
export default function ClientPage() {
  return <AuthProvider><ThemeProvider><DiagnosticoSLAPage /></ThemeProvider></AuthProvider>;
}
